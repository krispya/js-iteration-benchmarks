...
const bench = new IsoBench("Data packing strategies");

bench.add("F64: Separate Arrays", () => {
  // Setup
  const vector3 = {
...
bench.add("F64: Packed Contiguous Array", () => {
  // Setup
...
bench.add("F64: Packed Vector Array", () => {
  // Setup
...
bench.add("F32: Packed Contiguous Array", () => {
  // Setup
...
bench.add("F32: Packed Vector Array", () => {
  // Setup
